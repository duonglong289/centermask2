...
def setup(args):
    ...
    cfg.merge_from_file("/root/centermask2/configs/centermask/centermask_R_50_FPN_ms_3x.yaml")
    cfg.MODEL.WEIGHTS = "/root/centermask2/log_80_20/CenterMask-R-50-FPN-ms-3x/model_0034999.pth"
